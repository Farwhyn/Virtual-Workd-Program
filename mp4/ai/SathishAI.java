...
public class SathishAI extends AbstractAI {

    // constructor for SathishAI object
    public SathishAI() {
    }


    /**
     * This method determines the actions taken by Sathish
     * 
     * @param world
     *            the current world
     * 
     ...
     *            the current animal
     * 
     * @return the next action for Sathish
     */
    ...
    public Command getNextAction(ArenaWorld world, ArenaAnimal animal) {
        ...
        // Sathish wants to eat Antonio and Arabelle
        List<Item> listFood = super.getItem(possibleEats, "Fox", "Lion");
